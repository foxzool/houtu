...
/// A buffer is a binary blob. It is either the binary chunk of the subtree file,
/// or an external buffer referenced by a URI.
...
pub struct Buffer {
    ...
    /// when using the binary subtree format — when omitted the buffer refers to the binary chunk of the subtree file.
